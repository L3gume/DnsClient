...
public class DnsMessage {
    ...
    private ByteBuffer buildHeader(short id) {
        ...
        var bytes = ByteBuffer.allocate(12); // we know exactly how much mem we need for that one
        // ID
        bytes.putShort(id);
        //bytes.add((byte)(id));
    ...
    private ByteBuffer buildBody() {
        var bytes = ByteBuffer.allocate(512); // allocate way more mem than needed
    ...
    private ByteBuffer parseDomainName() {
        var parsed = ByteBuffer.allocate(512); // allocate way more mem than needed
